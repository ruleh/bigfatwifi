 ...
 *	%GFP_ATOMIC.
 */
extern struct sk_buff *__alloc_skb(unsigned int size, gfp_t gfp_mask,
			    int fclone, int node)
{
...
extern void skb_add_rx_frag(struct sk_buff *skb, int i, struct page *page, int off,
		int size)
{
...
extern struct sk_buff *skb_copy(const struct sk_buff *skb, gfp_t gfp_mask)
{
...
extern __wsum skb_copy_and_csum_bits(const struct sk_buff *skb, int offset,
 ...
 */
extern void skb_prepare_seq_read(struct sk_buff *skb, unsigned int from,
 ...
 */
extern bool skb_partial_csum_set(struct sk_buff *skb, u16 start, u16 off)
{
