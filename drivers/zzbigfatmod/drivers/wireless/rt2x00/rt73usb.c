 ...
 */
static int modparam_nohwcrypt73;
module_param_named(nohwcrypt73, modparam_nohwcrypt73, bool, S_IRUGO);
MODULE_PARM_DESC(nohwcrypt73, "Disable hardware encryption.");
/*
 * Register access.
