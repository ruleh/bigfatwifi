 ...
 */
static int modparam_nohwcrypt28;
module_param_named(nohwcrypt28, modparam_nohwcrypt28, bool, S_IRUGO);
MODULE_PARM_DESC(nohwcrypt28, "Disable hardware encryption.");
