 ...
 */
static int modparam_nohwcrypt25;
module_param_named(nohwcrypt25, modparam_nohwcrypt25, bool, S_IRUGO);
MODULE_PARM_DESC(nohwcrypt25, "Disable hardware encryption.");
/*
 * Register access.
