...
enum opt_code
{
  ...
  OPT_fsched_pressure_algorithm_ = 792,      /* -fsched-pressure-algorithm= */
  OPT_fsched_rank_heuristic = 793,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 794,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 795,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 796,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 797,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 798,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 799,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 800,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 801,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 802,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 803,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 804, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 805,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 806,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 807,              /* -fsecond-underscore */
  OPT_fsection_anchors = 808,                /* -fsection-anchors */
  /* OPT_fsee = 809, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 810,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 811,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 812, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 813,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 814,          /* -fselective-scheduling2 */
  OPT_fshort_double = 815,                   /* -fshort-double */
  OPT_fshort_enums = 816,                    /* -fshort-enums */
  OPT_fshort_wchar = 817,                    /* -fshort-wchar */
  OPT_fshow_column = 818,                    /* -fshow-column */
  OPT_fshrink_wrap = 819,                    /* -fshrink-wrap */
  OPT_fsign_zero = 820,                      /* -fsign-zero */
  OPT_fsignaling_nans = 821,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 822,               /* -fsigned-bitfields */
  OPT_fsigned_char = 823,                    /* -fsigned-char */
  OPT_fsigned_zeros = 824,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 825,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 826,               /* -fsource-filename= */
  OPT_fsource_ = 827,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 828,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 829,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 830,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 831, */                 /* -fsquangle */
  OPT_fstack_arrays = 832,                   /* -fstack-arrays */
  /* OPT_fstack_check = 833, */              /* -fstack-check */
  OPT_fstack_check_ = 834,                   /* -fstack-check= */
  OPT_fstack_limit = 835,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 836,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 837,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 838,                /* -fstack-protector */
  OPT_fstack_protector_all = 839,            /* -fstack-protector-all */
  OPT_fstack_usage = 840,                    /* -fstack-usage */
  OPT_fstats = 841,                          /* -fstats */
  OPT_fstore_check = 842,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 843, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 844,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 845,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 846,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 847, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 848,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 849,                    /* -fsyntax-only */
  OPT_ftabstop_ = 850,                       /* -ftabstop= */
  /* OPT_ftarget_help = 851, */              /* -ftarget-help */
  OPT_ftarget_ = 852,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 853, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 854,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 855,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 856, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 857,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 858,             /* -fthreadsafe-statics */
  OPT_ftime_report = 859,                    /* -ftime-report */
  OPT_ftls_model_ = 860,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 861,               /* -ftoplevel-reorder */
  OPT_ftracer = 862,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 863,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 864,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 865,                  /* -ftrapping-math */
  OPT_ftrapv = 866,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 867,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 868,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 869,                       /* -ftree-ccp */
  OPT_ftree_ch = 870,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 871,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 872,                /* -ftree-copyrename */
  OPT_ftree_cselim = 873,                    /* -ftree-cselim */
  OPT_ftree_dce = 874,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 875,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 876,                       /* -ftree-dse */
  OPT_ftree_forwprop = 877,                  /* -ftree-forwprop */
  OPT_ftree_fre = 878,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 879,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 880,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 881,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 882,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 883,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 884,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 885, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 886,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 887,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 888,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 889,                   /* -ftree-phiprop */
  OPT_ftree_pre = 890,                       /* -ftree-pre */
  OPT_ftree_pta = 891,                       /* -ftree-pta */
  OPT_ftree_reassoc = 892,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 893, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 894,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 895,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 896,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 897,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 898, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 899, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 900,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 901,                /* -ftree-tail-merge */
  OPT_ftree_ter = 902,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 903,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 904,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 905,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 906,                       /* -ftree-vrp */
  OPT_funderscoring = 907,                   /* -funderscoring */
  OPT_funit_at_a_time = 908,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 909,               /* -funroll-all-loops */
  OPT_funroll_loops = 910,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 911,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 912,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 913,             /* -funsigned-bitfields */
  OPT_funsigned_char = 914,                  /* -funsigned-char */
  OPT_funswitch_loops = 915,                 /* -funswitch-loops */
  OPT_funwind_tables = 916,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 917,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 918,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 919,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 920,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 921,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 922,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 923,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 924,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 925,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 926,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 927, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 928,                /* -fvect-cost-model */
  OPT_fverbose_asm = 929,                    /* -fverbose-asm */
  /* OPT_fversion = 930, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 931,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 932,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 933,                    /* -fvisibility= */
  OPT_fvpt = 934,                            /* -fvpt */
  /* OPT_fvtable_gc = 935, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 936, */            /* -fvtable-thunks */
  OPT_fweak = 937,                           /* -fweak */
  OPT_fweb = 938,                            /* -fweb */
  OPT_fwhole_file = 939,                     /* -fwhole-file */
  OPT_fwhole_program = 940,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 941,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 942,              /* -fworking-directory */
  OPT_fwpa = 943,                            /* -fwpa */
  OPT_fwrapv = 944,                          /* -fwrapv */
  /* OPT_fxref = 945, */                     /* -fxref */
  /* OPT_fzee = 946, */                      /* -fzee */
  OPT_fzero_initialized_in_bss = 947,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 948,                      /* -fzero-link */
  OPT_g = 949,                               /* -g */
  OPT_gant = 950,                            /* -gant */
  OPT_gcoff = 951,                           /* -gcoff */
  OPT_gdwarf_ = 952,                         /* -gdwarf- */
  OPT_gen_decls = 953,                       /* -gen-decls */
  OPT_ggdb = 954,                            /* -ggdb */
  OPT_gnat = 955,                            /* -gnat */
  OPT_gnatO = 956,                           /* -gnatO */
  OPT_gno_record_gcc_switches = 957,         /* -gno-record-gcc-switches */
  OPT_gno_strict_dwarf = 958,                /* -gno-strict-dwarf */
  OPT_grecord_gcc_switches = 959,            /* -grecord-gcc-switches */
  OPT_gstabs = 960,                          /* -gstabs */
  OPT_gstabs_ = 961,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 962,                   /* -gstrict-dwarf */
  OPT_gtoggle = 963,                         /* -gtoggle */
  OPT_gvms = 964,                            /* -gvms */
  OPT_gxcoff = 965,                          /* -gxcoff */
  OPT_gxcoff_ = 966,                         /* -gxcoff+ */
  OPT_h = 967,                               /* -h */
  OPT_idirafter = 968,                       /* -idirafter */
  OPT_imacros = 969,                         /* -imacros */
  OPT_imultiarch = 970,                      /* -imultiarch */
  ...
  OPT_print_multiarch = 1054,                /* -print-multiarch */
